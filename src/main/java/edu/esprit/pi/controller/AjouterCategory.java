...
public class AjouterCategory {
        ...
        categoryListView.setCellFactory(param -> new ListCell<Category>() {
            ...
            protected void updateItem(Category item, boolean empty) {
                ...
                if (empty || item == null) {
                    ...
                    //
                    ImageView nameLabelImage = new ImageView(new Image(getClass().getResource("/edu/esprit/pi/images/icon_category.png").toString()));
                    ImageView budgetLimitLabelImage = new ImageView(new Image(getClass().getResource("/edu/esprit/pi/images/icon_budget.png").toString()));
    ...
    private Button createStyledButton(String text, String imagePath) {
        ...
        ImageView imageView = new ImageView(new Image(getClass().getResource("/edu/esprit/pi/images/"+imagePath).toString()));
    ...
    private ToggleButton ToggleImageButton(String imagePath) {
        ...
        Image image = new Image(getClass().getResource("/edu/esprit/pi/images/"+imagePath).toString());
...
//    }
    ...
    public void openAddCategoryPopup() {
        try {
            ...
            stage.getIcons().add(new Image(getClass().getResource("/edu/esprit/pi/images/icon_add.png").toString()));
    ...
    public void openStatPopup() {
        try {
            ...
            Stage stage = new Stage();
            stage.getIcons().add(new Image(getClass().getResource("/edu/esprit/pi/images/icon_stat.png").toString()));
            stage.initModality(Modality.APPLICATION_MODAL);
            stage.setScene(new Scene(root));
            stage.showAndWait();
        } catch (IOException e) {
