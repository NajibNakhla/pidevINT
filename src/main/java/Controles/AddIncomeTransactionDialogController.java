...
public class AddIncomeTransactionDialogController {
    ...
    private void initialize() {
        ...
        payeeComboBox.getItems().addAll(payeeNames);  // Add your actual payee names
    }
    ...
    @FXML
    private void addIncomeTransaction(ActionEvent event) {
            ...
            if (isValidInput()) {
                  ...
                  AccountService accountService = new AccountService();
                    ...
                    Transaction transaction = new Transaction(LocalDate.now(), TransactionType.INCOME, description, amount, this.accountId, this.accountId, 1, idPayee);
